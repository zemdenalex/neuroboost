...
🔴 **Прежняя запись «месячного вида календаря нет — и это не планируется» ОТМЕНЕНА Денисом
18.08.** Она была написана без знания того, что месячный вид **уже работал** в v0.2.1
...
⚠ Вместе с ним при переписывании на Go пропали ещё **две** возможности v0.2.1: запланировать
задачу на время кнопками и настроить рабочие часы. 🔴 **Прежняя редакция этой строки называла
