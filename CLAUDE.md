...
⚠ Вместе с ним при переписывании на Go пропали ещё четыре возможности v0.2.1: отметить задачу
выполненной из списка, запланировать задачу на время кнопками, действия над задачей, настройка
рабочих часов. Полное сравнение — `docs/analiz-bot-vs-web-2026-08-18.md` §2. Узел:
`learning-a-rewrite-can-drop-features-silently`.
