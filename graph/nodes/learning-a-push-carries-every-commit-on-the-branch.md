...
**Как применять:** агента с правками инфраструктуры (Dockerfile, go.mod, compose) запускать с `isolation: "worktree"`
или не пушить, пока он работает; перед push — `git log origin/develop..develop`, все ли коммиты свои и проверенные.
