...
✅ Ночью сделаны три (тест красный → зелёный, сабботаж красный): **M1** `0197111`, **M7** (кэш 5 мин: веб теперь тоже пишет переключатель), **M4** (легенда месяца). Остальные ждут тебя.
