...
**Сделано 26.09 (утро):** ✅ строка 2 повтор задачи (`a3b1f3e`) · ✅ 4 запланировать с выбором (`f371ab4`, `a42e7e7`) · ✅ 6 один язык (`96c0d82`, `c84b9d2`) · ✅ 7 подзадача из меню строки (`f01fe67`) · ✅ 9 дата «весь день» и несколько дней (`796c8de`) · ✅ 11 «каждые N» и «каждый год» (`5413110`). Попутно: запланированная задача остаётся в «К выполнению» (`6be5ba1`, как A15 бота). Открыто: 1, 3, 5 (решения Дениса), 8, 10, 12–18.
